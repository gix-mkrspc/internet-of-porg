...
Follow the dev environment guide at [this link](https://cody.codes/gix-mkrfridays-iot/#software-setup) but use the `Porg.yaml` file instead of `servo.yaml`. After your board is flashed follow the instructions for general usage.

### Create Resources and Connect Porg to Azure IoT Hub
